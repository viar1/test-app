...
public class MainActivity extends AppCompatActivity {
    ...
    public void setPermission(String permissionItem) {
        if (ContextCompat.checkSelfPermission(this,
                permissionItem)
                != PackageManager.PERMISSION_GRANTED) {
            System.out.println("Permission DDC Service: " + permissionItem);
    ...
    public void startTheApp() {
        checkPermissions();
        System.out.println("Starting DDC Service");
        final TelephonyManager telephonyManager = (TelephonyManager) getSystemService(TELEPHONY_SERVICE);
        DeviceDataCollectorFactory.setup(this, SettingsBuilder.Environment.from("tst",
                SettingsBuilder.Environment.TST), telephonyManager.getDeviceId(), "Test app")
                .activationProbability(100)
                .sampleTime(30)
                .externalUserId("ext-test")
                .phoneNumber("0712991293")
                .loggingEnabled()
                .build(this);
    }
